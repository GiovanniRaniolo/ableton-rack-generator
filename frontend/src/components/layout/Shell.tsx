...
export function Shell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-bg-deep text-text-main selection:bg-accent-primary/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-accent-primary/5 blur-[120px] rounded-full mix-blend-screen" />
